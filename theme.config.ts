...
export const theme = {
  ...
  hero: [
    ...
    },
    {
      ...
      sub: { en: "Drop everything. New season drops, only at Oryx.", ar: "وصل الموسم الجديد حصرياً لدى أوريكس." },
  ...
  marquee: {
    ...
    muted: {
      en: ["NEW SEASON IN", "SS25 COLLECTION NOW LIVE", "SHIPS TO KSA · UAE · QAT · KWT · BHR · OMN", "USE CODE OX20 FOR 20% OFF", "LIMITED DROPS", "PREMIUM MENSWEAR"],
      ar: ["الموسم الجديد", "مجموعة صيف 25 متوفرة الآن", "شحن إلى السعودية · الإمارات · قطر · الكويت · البحرين · عُمان", "استخدم OX20 لخصم 20%", "إصدارات محدودة", "أزياء رجالية فاخرة"],
    },
  },
