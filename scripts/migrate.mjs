...
const desc = (name, cat) =>
  `${name} — an Oryx staple in our ${cat} lineup. Cut for the Gulf climate, finished with premium fabrics, and designed to move from street to evening without effort. Machine washable. Ships across the GCC.`;
