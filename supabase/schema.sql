...
create table if not exists public.store_settings (
  ...
  promo_code text not null default 'OX20',
...
alter table public.store_settings add column if not exists promo_code text not null default 'OX20';
...
values ('store', 500, 25, 14, 'OX20', 20)
